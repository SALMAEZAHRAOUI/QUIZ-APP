...
export class LoginComponent implements OnInit, OnDestroy {
  ...
  generateDynamicResponse(spokenWords: string): string {
    ...
    if (lowerCaseWords.includes('hello') || lowerCaseWords.includes('hi')) {
      ...
      return `Hello! Welcome to the Quiz App. I am your virtual assistant! The current time is ${currentTime}. Our mission is to provide an engaging and fun learning experience through various quiz categories. How can I assist you today?`;
    }
